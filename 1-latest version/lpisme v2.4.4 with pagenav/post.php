            ...
            <div class="wrapper main" role="main">
                <article class="post" itemscope itemtype="http://schema.org/BlogPosting">
                    ...
                    <div class="post-content cf" itemprop="articleBody">
                        ...
                        <ul class="post-near">
                            <li class="prev" title="<?php _e('上一篇');?>"><?php $this->thePrev('<i class="icon icon-left"></i> %s'); ?></li>
                            <li class="next" title="<?php _e('下一篇');?>"><?php $this->theNext('%s <i class="icon icon-right"></i>'); ?></li>
                        </ul>
                    </div>
                </article>
