<?php if (!defined('__TYPECHO_ROOT_DIR__')) exit; ?>
	...
	<div id="footer">
		...
		<div>
			Theme is <span class="codename">Lpisme v2.3.5</span> by Chakhsu . <?php if ($this->options->icpNum): ?><a href="http://www.miitbeian.gov.cn/" target="blank"><?php $this->options->icpNum(); ?></a><?php endif; ?>
		</div>
		<div>
