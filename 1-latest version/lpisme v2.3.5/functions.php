...
function themeConfig($form) {
    ...
    $slogan = new Typecho_Widget_Helper_Form_Element_Text('slogan', NULL, NULL, _t('logo旁边的slogan'), _t('在这里输入slogan'));
    $form->addInput($slogan);

    //社交链接
    $socialweibo = new Typecho_Widget_Helper_Form_Element_Text('socialweibo', NULL, NULL, _t('logo旁边的slogan'), _t('在这里输入微博地址,带http://'));
    $form->addInput($socialweibo);
    $socialgithub = new Typecho_Widget_Helper_Form_Element_Text('socialgithub', NULL, NULL, _t('logo旁边的slogan'), _t('在这里输入github地址,带http://'));
    $form->addInput($socialgithub);
    $socialtwitter = new Typecho_Widget_Helper_Form_Element_Text('socialtwitter', NULL, NULL, _t('logo旁边的slogan'), _t('在这里输入twitter地址,带http://'));
    $form->addInput($socialtwitter);
    $socialemail = new Typecho_Widget_Helper_Form_Element_Text('socialemail', NULL, NULL, _t('logo旁边的slogan'), _t('在这里输入邮箱地址,如xxx@xxx.com'));
