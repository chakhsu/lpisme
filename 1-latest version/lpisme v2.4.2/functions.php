...
function themeConfig($form) {
    ...
    //社交链接
    $socialweibo = new Typecho_Widget_Helper_Form_Element_Text('socialweibo', NULL, NULL, _t('输入微博链接'), _t('在这里输入微博地址,带http://'));
    ...
    $socialemail = new Typecho_Widget_Helper_Form_Element_Text('socialemail', NULL, NULL, _t('输入邮箱地址'), _t('在这里输入邮箱地址,如xxx@xxx.com'));
