                    ...
                    <article class="index-post">
                        <div class="index-post-inner">
                            <div class="index-post-header cf">
                                <?php if (isset($this->fields->alg)): ?>
                                <div class="index-post-avatar avatar-format alg left"></div>
                                <?php elseif (isset($this->fields->code)): ?>
                                <div class="index-post-avatar avatar-format code left"></div>
                                ...
                                <div class="index-post-avatar avatar-format share left"></div>
                                ...
                                <?php elseif (isset($this->fields->photo)): ?>
                                <div class="index-post-avatar avatar-format photo left"></div>
